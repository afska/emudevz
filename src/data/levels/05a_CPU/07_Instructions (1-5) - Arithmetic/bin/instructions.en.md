...
| `ASL`  | Arithmetic Shift Left               | 🐏  | Shifts all the bits of the value held at an `address` one place to the left.<br><br>Bit `7` is placed in the `C` flag and bit `0` is set to `0`.<br><br>The `Z` and `N` flags are updated using the result.                                                                                                                                                                                                                    |
...
| `LSR`  | Logical Shift Right                 | 🐏  | Shifts all the bits of the value held at an `address` one place to the right.<br><br>Bit `0` is placed in the `C` flag and bit `7` is set to `0`.<br><br>The `Z` and `N` flags are updated using the result.                                                                                                                                                                                                                   |
