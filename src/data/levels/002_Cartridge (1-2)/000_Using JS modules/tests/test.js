...
it(
	'`/code/world.js` is a JS module that exports "w0rld"',
	async () => {
...
it(
	"`/code/index.js` imports the module from `/code/world.js`",
	() => {
...
it(
	"`/code/index.js` exports a function that returns 'h3ll0 w0rld'",
	() => {
