...
it("$407F contains $00", () => {
	cpu.memory.readAt(0x407f).should.equalHex(0x00, "readAt(0x407f)");
})({
...
it("all bytes from $4080 to $40BF contain $AA", () => {
	...
	addresses.forEach((address) => {
		...
		cpu.memory.readAt(address).should.equalHex(0xaa, name);
	});
})({
...
it("$40C0 contains $00", () => {
	cpu.memory.readAt(0x40c0).should.equalHex(0x00, "readAt(0x40c0)");
})({
